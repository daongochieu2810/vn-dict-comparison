...
import {View, Text, StyleSheet, Platform, SafeAreaView, Dimensions, FlatList, TouchableOpacity, TextInput, Modal} from 'react-native';
...
export default function ComparisonScreen() {
    ...
    <SafeAreaView>
       <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', marginTop: 15, paddingHorizontal: 5 }}>
            <FlatList 
                data={wordList}
            ...
            />
             <FlatList 
                ...
                style={{...styles.compCard,  borderTopRightRadius: index === 0 ? 10 : 0, 
